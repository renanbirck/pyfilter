...
#
# Created: Sat May 23 14:42:58 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_Design.setGeometry(QtCore.QRect(10, 420, 85, 26))
        ...
        self.groupBox_paramCalc.setGeometry(QtCore.QRect(180, 30, 211, 71))
        ...
        self.radioButton_FIR.setGeometry(QtCore.QRect(0, 50, 104, 22))
        ...
        self.radioButton_IIR.setGeometry(QtCore.QRect(0, 30, 104, 22))
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(10, 10, 171, 201))
        ...
        self.groupBox_2 = QtGui.QGroupBox(self.FIR_settings)
        self.groupBox_2.setGeometry(QtCore.QRect(0, 20, 161, 161))
        self.groupBox_2.setObjectName(_fromUtf8("groupBox_2"))
        self.radioButton_Window = QtGui.QRadioButton(self.groupBox_2)
        self.radioButton_Window.setGeometry(QtCore.QRect(0, 20, 131, 22))
        self.radioButton_Window.setChecked(True)
        self.radioButton_Window.setObjectName(_fromUtf8("radioButton_Window"))
        self.radioButton_Parks = QtGui.QRadioButton(self.groupBox_2)
        self.radioButton_Parks.setGeometry(QtCore.QRect(0, 40, 131, 22))
        self.radioButton_Parks.setObjectName(_fromUtf8("radioButton_Parks"))
        self.comboBox_Window = QtGui.QComboBox(self.groupBox_2)
        self.comboBox_Window.setGeometry(QtCore.QRect(0, 90, 131, 27))
        self.comboBox_Window.setObjectName(_fromUtf8("comboBox_Window"))
        self.label_Window = QtGui.QLabel(self.groupBox_2)
        self.label_Window.setGeometry(QtCore.QRect(0, 70, 56, 17))
        ...
        self.pushButton_addItem = QtGui.QPushButton(self.groupBox_4)
        self.pushButton_addItem.setGeometry(QtCore.QRect(0, 160, 51, 27))
        self.pushButton_addItem.setObjectName(_fromUtf8("pushButton_addItem"))
        self.pushButton_removeItem = QtGui.QPushButton(self.groupBox_4)
        self.pushButton_removeItem.setGeometry(QtCore.QRect(120, 160, 51, 27))
        ...
        self.tableWidget_FIR.setGeometry(QtCore.QRect(0, 20, 171, 141))
        ...
        self.stackedWidget_filterSpecs.setCurrentIndex(0)
...
"Type2", None))
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "FIR settings", None))
